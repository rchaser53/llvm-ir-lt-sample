...
pub fn create_printf(module: *mut LLVMModule) -> *mut LLVMValue {
    unsafe {
        ...
        let printf_type =
            LLVMFunctionType(LLVMInt32Type(), printf_args_type_list.as_mut_ptr(), type_length, 0);
...
pub fn get_field_value(
  ...
  unsafe {
    ...
    let field = LLVMBuildInBoundsGEP(builder, target_struct, range.as_mut_ptr(), 2, CString::new("").unwrap().as_ptr());
...
pub fn set_field_value(
  ...
  unsafe {
    ...
    let mut field = LLVMBuildInBoundsGEP(builder, target_struct, range.as_mut_ptr(), 2, CString::new("").unwrap().as_ptr());
